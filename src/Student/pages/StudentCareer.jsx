  ...
  return (
   ...
   <div className='flex flex-col sm:flex-row'>
                ...
                <section className='mb-8'>
                    <h1 className='text-[#111418] text-4xl font-bold leading-tight text-center mb-3 '> Discover Your Future Path</h1>
                    <p className='text-slate-500  font-medium leading-normal mb-8 text-center'>
   ...
   <section className='mt-13'>
    ...
    <div className='grid sm:grid-cols-3 gap-5'>
        {/* cards-1 */}
        <div>
            <div className=" rounded-xl border-2  hover:border-primary hover:shadow-[0_0_20px_rgba(43,238,121,0.1)] hover:-translate-y-1 transition-all duration-300 cursor-pointer flex flex-col">
