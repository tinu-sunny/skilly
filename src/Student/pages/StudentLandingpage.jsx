                      ...
                      {/* Search Course
                            ...
                            <section className='flex flex-row gap-5 flex-wrap items-start justify-start w-full'>
                               <div className="sm:w-[68%] w-full">
                                    {/* heading */}
                                    <div className='mt-10'>
                                        <h1 className='text-[#111418] font-bold text-4xl leading-tight mb-4 dark:text-white'>Job Appplication</h1>
                                    </div>
    ...
    {/* counselling section */}
                               <div className="sm:w-[30%] w-full">
                                    ...
                                    <div className='mt-10'>
                                        {/* heading */}
                                        <div className=''>
                                            <h1 className='text-[#111418] text-4xl font-bold mb-4 leading-tight dark:text-white'>Counselling Hub</h1>
                                        </div>
                            ...
                            <section>
                                ...
                                <div className='mb-5 mt-10'>
                                     <h1 className='text-[#111418] text-3xl font-bold leading-tight dark:text-white'>My Courses</h1>
                                </div>
    
                                {/* Active course  box */}
                                <div className='w-full shadow-2xl sm:h-70 h-auto bg-slate-100 rounded-2xl dark:bg-gray-600'>
