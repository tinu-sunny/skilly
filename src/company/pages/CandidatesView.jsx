  ...
  return (
    <>
        <div className=" flex sm:flex-row flex-col w-full dark:bg-black">
         ...
         <div>
            <div><TextInput type="search" placeholder="search here .... 🔎"></TextInput></div>
            <div  className="mt-5 flex sm:justify-center lg:justify-end items-center  gap-10">
                {/* sort */}
                <div className=" ">
                    <select name="" id="" className="bg-gray-300 border-0 rounded-2xl shadow-2xl p-2 dark:bg-blue-500 dark:text-white">
