  ...
  return (
      ...
      <div className="flex sm:flex-row flex-col  dark:bg-black ">
        ...
        <div className="sm:mt-5 p-5 sm:p-0 w-full ">
                  ...
                  <div>
                     <h1 className="text-[#11418] text-3xl font-bold leading-tight dark:text-white">Welcome Back <span>Companay name</span></h1>
                     <p className="text-slate-400 leading-tight font-semibold dark:text-white">Manage you job applcationa</p>
                  </div>
{/* 3 qucki books */}
                 ...
                 <section className="sm:w-full lg:w-[90%]">
                    <div className="border-2 border-gray-300 bg-gray-50 shadow-2xl rounded-2xl p-5  mt-10  dark:bg-gray-500 dark:border-0 dark:text-white">
                      <div className="flex justify-between items-center">
                        <p className="text-[#11418] font-bold leading-tight text-xl">Recent Application</p>
                        <Button outline className="dark:text-white">view all</Button>
                      </div>
                      <hr  className="mt-4 "/>
  ...
  <TableHead>
    <TableRow >
      ...
      <TableHeadCell className="dark:text-white">Position</TableHeadCell>
      <TableHeadCell className="dark:text-white">Applied Date</TableHeadCell>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell className="dark:text-white">Developer</TableCell>
      <TableCell className="dark:text-white">20-01-2026</TableCell>
      <TableCell className="dark:text-white">Under review</TableCell>
    </TableRow>
