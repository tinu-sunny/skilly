        ...
        <section>
          <div className="flex flex-col gap-10 px-4 py-10  ">
            ...
            <div className="flex flex-col gap-4">
              <h1 className="text-[#111418] tracking-light font-bold text-4xl leading-tight dark:text-white">
                How Skillly Works
              </h1>
              <p className="text-[#111418] text-base font-normal leading-normal dark:text-[#f7f7f7c7]">
                {" "}
                Skillly provides a comprehensive suite of tools and resources to
                support career development and professional networking.
              </p>
            </div>
            {/* card section */}
            ...
            <div className="grid   sm:grid-cols-1     md:grid-cols-2  lg:grid-cols-4  gap-3 w">
              ...
              <div className="flex flex-col gap-3 pb-3">
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBA6QUfX72mVmiK2LxCL-axnVhkJFW5mgTrp2TgIAskMG273tk1pBPnWiT_WwSPIC6nIh-LEv9J3f1SQSBdU44zgcJAbFLWOrxSiMZblgsXnWFPz0bEZp37AExnv2NgPlKa8fP-3QLU2m6PyFEVkHI20XOrIx6wyCEf9OSsBbSJooP4X9aio2McUloo1E-VGun7p4C25P3PLIp_8ZuthP4vFAgkwIMSCRWZfjyzRl40abVhSHTe6Rb4__sEEeNE71upIKOYS3ndJVRN')",
                  }}
                ></div>
                {/* content section */}
                <div>
                  ...
                  <p className="text-[#617589] text-sm font-normal leading-normal dark:text-slate-500">
                    Counselors can provide tailored support, track student
                    progress, and access valuable resources.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 pb-3">
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCufaTKi5lxZAbfN4VNNb-pmj6tNdMvDI3TE4DcyWSpVyZ_ZZE1eq37224xYydGb0hKs8kSOmIrxmNfEsGSSHE6bkVLvMvBHePESDL34NpZB5MvaJDyglnyd0ph34r4cEHAUl5atBVcz49bHiHI5aG16dxgMkk5zTAJU8NfIolGL-HGzzMZpzhhHDNpqFVBWN8CsGOxZp9VWwBqgqAOjy_6Zt2yDZGaDWxdW0cXP1DCZ8PcQp3PJYsE26sBHZfZip4yjfSKFU3pVtrW')",
                  }}
                ></div>
                {/* content section */}
                <div>
                  ...
                  <p className="text-[#617589] text-sm font-normal leading-normal dark:text-slate-500">
                    {" "}
                    Institutions can enhance career services, connect students
                    with opportunities, and measure outcomes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 pb-3">
                ...
                <div>
                  ...
                  <p className="text-[#617589] text-sm font-normal leading-normal dark:text-slate-500">
                    {" "}
                    Companies can find top talent, engage with potential
                    candidates, and build a strong employer brand.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section>
          <div className="grid grid-cols sm:grid-cols-2 m-5 ">
            ...
            <motion.div
              ...
              className="flex flex-col gap-5 text-start justify-center mb-5"
            >
              {/* About */}
              <div className="flex  flex-wrap justify-between gap-3 p-0 sm:p-4">
                <h1 className="text-[#111418] font-bold leading-tight text-4xl tracking-light dark:text-white">
                  About Skilly
                </h1>
              ...
              {/* Vison */}
              <div className="flex  flex-wrap justify-between gap-3 p-0 sm:p-4">
                <h1 className="text-[#111418] font-bold leading-tight text-3xl tracking-light dark:text-white">
                  Our Vison
                </h1>
                <p className="text-[#111418] text-base font-medium leading-normal  sm:pt-1 sm:px-2 sm:font-normal sm:text-base dark:text-slate-500">
                  {" "}
                  To be the premier global platform for career development,
                  fostering a community where every individual can achieve their
            ...
            >
              <img
                className="w-full aspect-auto rounded-lg h-auto shadow-2xl shadow-amber-100  sm:p-3"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAL2IrBo4HW2UzWAWJMpfn1a9akYmHB1S4BVhTNZOMOPWcn8JMEWZNhxVkwEYP48ojZN9TwaGAwDt4cYqhxqQhg_CFvrumP9uTfoskIeoElRKmU3ONoUIIMnQXizXDNgFaAMMiddWgkswiSmKmNnh0HdmiI-uZz6NZ9kp4VyBhd8VWhtaAgnTaZfS8zra6LerBcTNDpcFG-epbnNVsw4e5DZRm0du-UzkecJHHKXGmK2N2vEqeFTCc5Pwlv08X6uEgdzMANwa_JUNpa"
                alt=""
              />
            </motion.div>
          </div>
        ...
        >
          <div className="mt-8">
            ...
            <div className="flex  justify-center mt-5 mb-5">
              <h1 className="text-[#111418] text-3xl font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5 mt-4 dark:text-white">
                {" "}
                News & Updates{" "}
              </h1>
            </div>
            ...
            <div className="flex flex-wrap flex-col gap-3">
              ...
              <div className="flex flex-row justify-around flex-wrap gap-3 p-4 sm:p-0  ">
                ...
                <div>
                  ...
                  <h1 className="text-[#111418] text-base font-bold leading-tight dark:text-slate-500">
                    Skilly Announces New Partnership with Leading Universities
                  </h1>
                  <p className="text-[#617589] text-sm font-normal leading-normal">
                    Skilly Partners with top Universities to enhance career
                ...
                <div className=" flex flex-end">
                  <motion.img
                    ...
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCxZsX2CGD0gayAEg5_pcvp7zPuNOfsNAplfByYADAU8Rp60ZN9Fs70uoFjvUcXGz0ibmp4IUl7LdgaFGqrFfKSXKM9BjaMpXWa7_HogoyKYKWvvwDQcHF7-wdbRwzt1OjtgDrqvWmAovOPTYzIsdDIOWL9m7j5qKqIXUi58fSd7HlMZcG_h_vr0ej2DM7yUipaQ-lEfZotwCjlfixqDLW5knY7ogoeYJaoMPomOHEuc3d4m8rLhnb6YieIgTR1Q7pm1FYT5vyBSoBO  "
                    alt=""
                  />
                </div>
              </div>
              ...
              <div className="flex flex-row justify-around flex-wrap gap-3  ">
                ...
                <div className=" flex flex-end">
                  <motion.img
                    ...
                    transition={{ duration: 0.7 }}
                    className="rounded-lg h-40 w-70 "
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuD9NtEX2YuoGZgxn7Lc3JiNDjB9MW8G_fZd5W-FIgeEk-m_Crvys0DQAaj3v2dKQ4CPmEkOcBWtu3nQwc5Zn8cGB2h2ZPMlVm0dOn4bq_gFov0eoMxIp8ytNVhjt58fnF4Nfr1VF8gQenMKg1S8sdcODMBBW6ExQQQd4WW0EcABJH1cCavlZ3CjQtUm42QY-O6UvQt_C0mb3siMdfpp_BgIXLK08PkG8vEwcHr6ciEj99okx_7u6N-HDWGJDBbJGYQQhNj8uCaENhdP"
                    alt=""
                  />
                </div>
              </div>
