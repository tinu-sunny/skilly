        ...
        <div className="grid grid-cols sm:grid-cols-2 m-5 ">
          ...
          >
            ...
            <div className="flex  flex-wrap justify-between gap-3 p-0 sm:p-4">
              <h1 className="text-[#111418] font-bold leading-tight text-4xl tracking-light">
                About Skilly
              </h1>
              <p className="text-[#111418] text-base font-medium leading-normal  sm:pt-1 sm:px-2 sm:font-normal sm:text-base">
                {" "}
            ...
            {/* Vison */}
            <div className="flex  flex-wrap justify-between gap-3 p-0 sm:p-4">
              <h1 className="text-[#111418] font-bold leading-tight text-3xl tracking-light">
                Our Vison
              </h1>
              <p className="text-[#111418] text-base font-medium leading-normal  sm:pt-1 sm:px-2 sm:font-normal sm:text-base">
                {" "}
      ...
      >
        <div className="mt-8">
          ...
          <div className="flex  justify-center mt-5 mb-5">
            <h1 className="text-[#111418] text-3xl font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5 mt-4">
              {" "}
              News & Updates{" "}
            </h1>
          </div>
