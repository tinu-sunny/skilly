  ...
  return (
    <>
      ...
      <div className="dark:bg-black">
        ...
        <section>
          <h1 className="text-center font-bold text-[#111418] tracking-light  leading-tight text-4xl p-4 dark:text-white">
            Skillly Services
          </h1>
          <p className="text-center  text-[#617589] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
            Empowering your career journey with comprehensive support and
            resources.
          </p>
        </section>
        ...
        <section className="p-10 sm:p-15 w-full">
          <div className="flex flex-col gap-5">
            ...
            <div className="">
              <h1 className="font-bold text-4xl text-[#111418] tracking-light  leading-tight mb-3 dark:text-white">
                Career Guidance
              </h1>
              <p className="text-[#111418cc] text-sm font-bold leading-normal max-w-250 sm:px-10 dark:text-[#f7f7f7c7]">
                {" "}
                Skillly offers personalized career guidance to help you discover
                your ideal path. Our tools and resources provide insights into
                various career options, helping you make informed decisions
                about your future.
              </p>
            </div>
            ...
            <div className="gap-5 flex flex-col sm:flex-row">
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0 ">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Tailored career suggestions based on your skills and
                    interests.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0 ">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Explore diverse career paths and their requirements.
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="">
              ...
              <p className="text-[#111418cc] text-sm font-bold leading-normal max-w-250 sm:px-10 dark:text-[#f7f7f7c7]">
                ...
                Skillly's networking platform facilitates meaningful
                interactions, helping you build valuable relationships and
            ...
            <div className="gap-5 flex  flex-wrap">
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Build connections with industry experts and peers.
                  </p>
                </div>
              </div>
              {/* card-2 */}
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Participate in virtual and in-person networking events.
                  </p>
                </div>
              </div>
        ...
        <section className="p-10 sm:p-15 w-full">
          <div className="flex flex-col gap-5">
            ...
            <div className="">
              ...
              <p className="text-[#111418cc] text-sm font-bold leading-normal max-w-250 sm:px-10 dark:text-[#f7f7f7c7]">
                {" "}
                Receive guidance from experienced counselors and mentors who can
                provide personalized advice and support. Our mentorship program
                connects you with professionals who can share their expertise
                and help you navigate your career.
              </p>
            </div>
            ...
            <div className="gap-5 flex flex-col sm:flex-row">
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Connect with mentors who have been vetted for their
                    expertise.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Engage in live conversations with mentors for immediate
                    support.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Receive tailored guidance based on your specific needs and
                    goals.
                  </p>
                </div>
              </div>
        ...
        <section className="p-10 sm:p-15 w-full">
          <div className="flex flex-col gap-5">
            ...
            <div className="">
              ...
              <p className="text-[#111418cc] text-sm font-bold leading-normal max-w-250 sm:px-10 dark:text-[#f7f7f7c7] ">
                {" "}
                Enhance your skills with Skillly's curated resources and
                training programs. We offer a range of courses and workshops
                designed to help you develop the competencies needed to succeed
            ...
            <div className="gap-5 flex flex-col sm:flex-row">
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Access a selection of courses relevant to your career path.
                  </p>
                </div>
              </div>
              {/* card-2 */}
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Participate in hands-on workshops to develop practical
                    skills.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Earn certifications to validate your expertise and enhance
                    your resume.
                  </p>
                </div>
              </div>
        ...
        <section className="p-10 sm:p-15 w-full">
          <div className="flex flex-col gap-5">
            ...
            <div className="">
              ...
              <p className="text-[#111418cc] text-sm font-bold leading-normal max-w-250 sm:px-10 dark:text-[#f7f7f7c7]">
                {" "}
                Skillly partners with educational institutions and companies to
                provide comprehensive career support. We offer tailored programs
                and resources to help students and employees achieve their
                career goals.
              </p>
            </div>
            ...
            <div className="gap-5 flex flex-col sm:flex-row">
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Customized career services for institutions and companies.
                  </p>
                </div>
              </div>
              {/* card-2 */}
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Dedicated resources and support for students.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Programs to enhance employee skills and career progression.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="p-10 sm:p-15 w-full">
          <div className="flex flex-col gap-5">
            ...
            <div className="">
              ...
              <p className="text-[#111418cc] text-sm font-bold leading-normal max-w-250 sm:px-10 dark:text-[#f7f7f7c7]">
                {" "}
                Access a variety of resources and tools to support your career
                journey. Skillly provides articles, guides, and interactive
                tools to help you navigate the job market and achieve your
            ...
            <div className="gap-5 flex flex-col sm:flex-row">
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Stay informed with articles on career trends and advice.
                  </p>
                </div>
              </div>
              {/* card-2 */}
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Use tools like resume builders and interview simulators.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col dark:bg-blue-800 dark:border-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#111418cc] text-sm font-normal leading-normal dark:text-[#f7f7f7c7]">
                    Gain insights into job market trends and salary
                    expectations.
                  </p>
                </div>
              </div>
