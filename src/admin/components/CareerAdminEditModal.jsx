  ...
  return (
    <>
      <div className="flex flex-wrap gap-4">
        <Button className="bg-[#0426bd]" onClick={() => setOpenModal(true)}>
          Edit
        </Button>
      </div>
        ...
        <ModalBody>
          <div className="space-y-6 p-6">
            ...
            <div>
              ...
              <TextInput
                value={courseData.avgsalary}
                onChange={(e) => {
                  setCourseData({ ...courseData, avgsalary: e.target.value });
                }}
              />
            </div>
            <div>
            ...
            {preview ? (
              ...
              <img
                src={`${serverURL}/uploads/${courseData.thumbnail}`}
