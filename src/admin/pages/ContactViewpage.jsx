...
const [errMsg, setErrMsg]=useState('')
 ...
 // search and sort
  ...
  return (
    <>
      <div
        className="flex sm:flex-row flex-col dark:bg-black"
        style={{ height: "100vh" }}
      >
        {/* header */}
        <div className="">
        ...
        <div className=" p-5 w-full  dark:bg-black ">
          ...
          <div className="sm:text-start text-center">
            ...
            <p className="text-slate-500 font-medium leading-tight m-2 dark:text-white">
              Manage and respond to user inquiry
            </p>
          </div>
                      ...
                      <TableBody className="divide-y">
                        {sortData && sortData.length > 0 ?sortData.map((data, index) => (
                          ...
                          >
                            ...
                            <TableCell>
                              <a
                                href={`mailto:${data.email}?subject=inquiry for ${data.inquiryType} Request&body=Hello Sir/mam`}
