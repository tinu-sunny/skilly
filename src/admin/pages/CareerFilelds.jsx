...
import { carrerfieldDelete, viewCarreerAPI } from "../../services/allAPIs";
...
function CareerFilelds() {
  ...
  const handleDelete = async (id) => {
    ...
    const response = await carrerfieldDelete(userid);
    // console.log(response);
    if (response.status == 200) {
          ...
          <div className="p-3">
            ...
            <div className="flex flex-col gap-3 p-4">
              <div className="flex  justify-end">
                <CareerAdminaddModal setRefresh={setRefresh} />
              </div>
                      ...
                      {currentItems && currentItems.length > 0 ? (
                        currentItems.map((user) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4">
                              <Button
                                className="bg-red-800 hover:bg-red-400 dark:bg-red-800"
                        ...
                        <tr>
                          <td
                            colSpan={6}
                            className="text-center text-2xl p-5  bg-gray-300"
                          >
                            {errMsg}
                          </td>
                        </tr>
